...
startup/%.o: ../startup/%.s
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -Wa,-mimplicit-it=always -D__NEWLIB__ -I"/home/eric/dev/baremetal/nxp-lpc55s69-evk/labos-lpc55s69-evk/LPC55S69_OS.src/board" -I"/home/eric/dev/baremetal/nxp-lpc55s69-evk/labos-lpc55s69-evk/LPC55S69_OS.src/source" -g3 -mcpu=cortex-m33 -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -D__NEWLIB__ -specs=nano.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
